...
If you stuck anywhere, please do _python helper.py -h_** or *python helper.py --help* . All the informations and instructions are being displayed once you run that.  
